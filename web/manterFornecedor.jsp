...
<html>
  ...
  <body>
      <div class="centro">
        ...
        Codigo: <br><input type="text" name="codFornecedor" value="${fornecedor.codFornecedor}"<c:if test="${operacao != 'Incluir'}"> readonly</c:if>/><br>
        Razão Social: <input type="text" name="razaoSocial" value="${fornecedor.razaoSocial}"<c:if test="${operacao == 'Excluir'}"> readonly</c:if>/>
        CNPJ: <input type="text" name="cnpj" value="${fornecedor.cnpj}"<c:if test="${operacao == 'Excluir'}"> readonly</c:if>/> <br><br>
        Nome Fantasia: <br><input type="text" name="nomeFantasia" value="${fornecedor.nomeFantasia}"<c:if test="${operacao == 'Excluir'}"> readonly</c:if>/>
        Nome do Contato: <input type="text" name="nomeContato" value="${fornecedor.nomeContato}"<c:if test="${operacao == 'Excluir'}"> readonly</c:if>/><br>
        CEP <input type="text" name="cep" value="${fornecedor.cep}"<c:if test="${operacao == 'Excluir'}"> readonly</c:if>/>
        ...
        Telefone 1 <br><input type="text" name="telefone1" value="${fornecedor.telefone1}"<c:if test="${operacao == 'Excluir'}"> readonly</c:if>/>
